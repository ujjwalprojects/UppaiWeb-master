            ...
            c = {
                slide: function (i, t) {
                    ...
                    e.css({ left: i.upcoming_position, display: "block" }),
                        s.$control.animate({ left: i.offset }, function () {
                ...
                fade: function (i, t) {
                    ...
                    o.css({ left: this.width, opacity: 0, display: "block" }).animate({ opacity: 1 }),
                        i.outgoing_slide >= 0
                ...
                if (!(this.animating || ((this.animating = !0), void 0 === t && (t = "next"), (s.upcoming_slide = this._upcomingSlide(t)), s.upcoming_slide >= this.size()))) {
                    ...
                    e.$el.trigger("animating.slides", [s]),
                        e.animation(s, function () {
                            e._findPositions(s.upcoming_slide, e), "function" == typeof n && n(), (e.animating = !1), e.$el.trigger("animated.slides"), e.init || (e.$el.trigger("init.slides"), (e.init = !0), e.$container.fadeIn("slow"));
                        });
                }
            },
        }),
