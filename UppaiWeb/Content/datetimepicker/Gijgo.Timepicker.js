...
(gj.widget = function () {
        ...
        initialize: function (a, b, c) {
            ...
            (d =
                "bootstrap" === b.uiLibrary
                    ...
                    ? $('<span class="input-group-append"><button class="btn btn-danger border-left-0 " type="button" id="TimeClock">' + b.icons.rightIcon + "</button></span>")
                        : $(b.icons.rightIcon)),
    ...
    (gj.timepicker.config = {
        base: {
            ...
            locale: "en-us",
            size: "default",
            icons: { rightIcon: '<i class="fa fa-clock" />' },
